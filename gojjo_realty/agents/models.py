...
class Agent(BaseAgentModel):
    ...
    focus_areas = ArrayField(models.TextField(max_length=255, blank=True), blank=True, null=True,)
    practice_areas = ArrayField(models.TextField(max_length=255, blank=True), blank=True, null=True,)
