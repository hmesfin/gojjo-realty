...
class Lead(BaseTimeStampModel):
    ...
    valid_lead = models.BooleanField(_('Valid Lead'), default=False)
    ...
    def get_update_url(self):
        return reverse('contacts:lead-update', kwargs={'pk': self.pk})
    ...
    def age(self):
        import datetime
        return int((datetime.date.today() - self.birthdate).days / 365.25) if self.birthdate else None